				...
				<div class="billcontent">
					...
					<div class="billcontent-left">
						<table>
							...
							<tbody>
								<tr>
									<td><a href="" title="Xóa" class="billcontent-remove"><img
											src="images/remove-icon.png" /></a></td>
									<td><a href=""><img src="" alt="item" width="100"
											height="100" /></a></td>
									<td><a href="">Tên và 1 số thông tin sản phẩm</a></td>
									<td><span>Loại hình</span></td>
									<td><span>Giá <span>VNĐ</span></span></td>
									<td><input min="0" max="10" type="number" value=""
										size="1" /></td>
									<td><span>Giá <span>VNĐ</span></span></td>
					...
					<div class="billcontent-right">
						...
						<div class="billcontent-right-checkout">
							<a href="billcontent_info.html"><strong>TIẾN HÀNH
									THANH TOÁN</strong></a>
						</div>
