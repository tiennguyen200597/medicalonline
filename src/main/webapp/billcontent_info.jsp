		...
		<div class="mainbody">
			...
			<div class="home-mid-mainbody">
				...
				<div class="billcontent">
					...
					<div class="billcontent-info-left">
						<h3>THÔNG TIN THANH TOÁN</h3>
						<div class="billcontent-info-left-table">
							<table>
								<tbody>
									<tr>
										<th style="width: 150px" align="left">Họ và Tên</th>
										<td>Họ tên người nhận hàng được truyền từ db</td>
									</tr>
									<tr>
										<th align="left">Số điện thoại</th>
										<td>Số điện thoại người nhận được truyền từ db</td>
									</tr>
									<tr>
										<th align="left">Địa chỉ</th>
										<td>Địa chỉ người nhận được truyền từ db</td>
									</tr>
								</tbody>
							</table>
						</div>
						<div class="billcontent-info-left-addinfo">
							<div class="billcontent-info-left-addinfo-click">
								<a id="btn-addinfo" href="#"><strong>Thêm địa chỉ
										mới</strong></a>
							</div>
							<form id="form-addinfo"
								class="billcontent-info-left-addinfo-form">
								<table>
									<tbody>
										<tr>
											<th style="width: 150px" align="left">Tên</th>
											<td><input type="text" placeholder="Điền tên" /></td>
										</tr>
										<tr>
											<th align="left">Số điện thoại</th>
											<td><input type="text" placeholder="Điền số điện thoại" /></td>
										</tr>
										<tr>
											<th align="left">Tỉnh/Thành phố</th>
											<td><input type="text" placeholder="Điền Tỉnh/Thành phố" /></td>
										</tr>
										<tr>
											<th align="left">Quận/Huyện</th>
											<td><input type="text" placeholder="Điền Quận/Huyện" /></td>
										</tr>
										<tr>
											<th align="left">Phường/Xã</th>
											<td><input type="text" placeholder="Điền Phường/Xã" /></td>
										</tr>
										<tr>
											<th align="left">Địa chỉ cụ thể</th>
											<td><input type="text"
												placeholder="Điền số nhà, tên đường, khu vực" /></td>
										</tr>
										<tr>
											<td align="right"><input style="width: 50px"
												type="button" id="btn-huyaddinfo" value="Hủy" /></td>
											<td><input type="submit" value="Lưu"
												class="billcontent-info-left-addinfo-form-saveinfo" /></td>
										</tr>
									</tbody>
								</table>
								<script language="javascript">
 
            document.getElementById("btn-huyaddinfo").onclick = function () {
                document.getElementById("form-addinfo").style.display = 'none';
            };
 
            document.getElementById("btn-addinfo").onclick = function () {
                document.getElementById("form-addinfo").style.display = 'block';
            };
						...
						<div class="billcontent-info-left-notes">
							<table>
								<tbody>
									<tr>
										<th style="width: 100px">Ghi chú</th>
										<td style="width: 300px"><textarea style="width: 100%"
												placeholder="Ghi chú về đơn hàng của bạn. Ví dụ: thời gian có thể nhận, địa điểm chi tiết hơn"></textarea></td>
									</tr>
								</tbody>
							</table>
						</div>
					</div>
					<div class="billcontent-info-right">
						<h3>ĐƠN HÀNG CỦA BẠN</h3>
						<div class="billcontent-info-right-table">
							<table>
								<thead>
									<tr>
								...
								<tbody>
									<tr>
										<td>Tên sản phẩm</td>
										<td><span>Giá <span>VNĐ</span></span></td>
									</tr>
								</tbody>
								<tfoot>
									<tr>
										<th>Tiền dịch vụ sử dụng</th>
										<td><span>Giá <span>VNĐ</span></span></td>
									</tr>
									<tr>
						...
						<div class="billcontent-info-right-checkout">
							<button type="submit" name="" id="" value="">ĐẶT HÀNG</button>
						</div>
					</div>
				</div>
				<!-- InstanceEndEditable -->
			...
			<div class="footer-bottom">
				...
				<div class="footer-bottom-menu">
					<ul>
						...
						<li class="active"><a href="billcontent.html">THANH TOÁN</a></li>
